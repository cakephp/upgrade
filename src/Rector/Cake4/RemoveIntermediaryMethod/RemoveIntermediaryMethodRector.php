...
namespace Cake\Upgrade\Rector\Cake4\RemoveIntermediaryMethod;

use Cake\Upgrade\Rector\Cake4\FluentChainMethodCallNodeAnalyzer;
use PhpParser\Node;
...
/**
 * @see https://book.cakephp.org/4.next/en/appendices/4-3-migration-guide.html
 *
...
final class RemoveIntermediaryMethodRector extends AbstractRector implements ConfigurableRectorInterface
{
    ...
    /**
     * @var array<\Cake\Upgrade\Rector\Cake4\RemoveIntermediaryMethod\RemoveIntermediaryMethod>
     */
